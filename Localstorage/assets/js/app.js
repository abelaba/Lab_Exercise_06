...
const ascend = document.querySelector('.ascending'); //the reload button at the top navigation
...
ascend.addEventListener('click',a);
descend.addEventListener('click',b);
...
document.addEventListener('DOMContentLoaded',loadtasksfromDB(myDB));

function loadtasksfromDB(load){
    let tasks = load;
